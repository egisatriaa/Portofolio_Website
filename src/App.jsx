    ...
    return (
        <>
            ...
            <div className="kontak mt-32 sm:p-10 p-0" id="kontak">
                ...
                <form action="https://api.web3forms.com/submit" method="POST" className="bg-zinc-800 p-10 sm:w-fit w-full mx-auto rounded-md" autoComplete="off" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="500">
                    {/* ACCESS KEY WAJIB */}
                    <input type="hidden" name="access_key" value="05bab85e-2f0e-488e-ac90-01430bffd014" />

                    <div className="flex flex-col gap-6">
                        {/* NAMA */}
                        <div className="flex flex-col gap-2">
                            <label className="font-semibold">Nama lengkap</label>
                            <input type="text" name="name" placeholder="Masukkan Nama..." className="border border-zinc-500 p-2 rounded-md" required />
                        </div>
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <textarea name="message" id="pesan" cols="45" rows="7" placeholder="Masukkan Pesan..." className="border border-zinc-500 p-2 rounded-md" required></textarea>
                        </div>
